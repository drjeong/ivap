 ...
 * Author: Dong H Jeong
 * Desc: Showing all user accounts
 * History
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div>
                        <p style="margin-top:0.2in;text-align:center;"><span style="font-size:13pt;font-weight:bold;">Listing of User Accounts</span>&nbsp;</p>
                    </div>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Content Row -->
                    <div class="row">
                        <?php include('useraccounts_c.php'); ?>
                    </div>
                </div>
                <!-- End Page Content -->
